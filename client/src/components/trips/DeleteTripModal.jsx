...
const DeleteTripModal = ({ isOpen, onClose, onConfirm, trip, loading }) => {
  if (!trip) return null;
        ...
        <div className="flex items-start space-x-3 p-3.5 bg-rose-500/10 border border-rose-500/20 rounded-xl text-rose-300">
          ...
          <div className="text-xs space-y-1">
            ...
            <p className="text-rose-300/80">
              This action cannot be undone. All associated itinerary stops and expenses will be permanently deleted.
            </p>
          </div>
        </div>
